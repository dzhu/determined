...
def set_master_server_name(name: Optional[str]) -> None:
    global _master_server_name
    _master_server_name = name
...
set_master_server_name(os.environ.get("DET_MASTER_SERVER_NAME"))
...
def do_request(
    ...
    try:
        r = determined_common.requests.request(
            ...
            server_hostname=_master_server_name,
        )
